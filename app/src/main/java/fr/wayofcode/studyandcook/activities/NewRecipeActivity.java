...
public class NewRecipeActivity extends AppCompatActivity implements VerticalStepperForm {
    ...
    private static final int PRICE_STEP_NUM = 5;
    private static final int RECIPE_CATEGORIE_STEP_NUM = 6;
...
//                break;
    ...
    private View createCategoriesStep() {
        Spinner categoriesSpinner = new Spinner(this);

        // load categories from database
        List<String> lables=mDBhelperRecipes.getAllCategoriesLabels();
